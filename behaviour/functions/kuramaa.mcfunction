execute @s[scores={chakra=..75}] ~~~ execute @s[scores={chakra=50..}] ~~~ replaceitem entity @s slot.armor.chest 1 porkyn:kurama_1
execute @s[scores={chakra=..49}] ~~~ execute @s[scores={chakra=30..}] ~~~ replaceitem entity @s slot.armor.chest 1 porkyn:kurama_2
execute @s[scores={chakra=..29}] ~~~ execute @s[scores={chakra=1..}] ~~~ replaceitem entity @s slot.armor.chest 1 porkyn:kurama_3
execute @s[scores={chakra=..5}] ~~~ execute @s[scores={chakra=1..},tag=!batalha_kurama] ~~~ give @s porkyn:batalha_kurama
execute @s[scores={chakra=..5}] ~~~ execute @s[scores={chakra=1..},tag=!batalha_kurama] ~~~ tag @s add batalha_kurama
